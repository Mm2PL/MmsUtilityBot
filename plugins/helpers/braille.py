...
def to_braille_from_url(image_url: str, reverse: bool = False, size_percent: typing.Optional[float] = None,
                        max_x: typing.Optional[int] = None, max_y: typing.Optional[int] = None,
                        sensitivity: typing.Tuple[float] = (0.5, 0.5, 0.5, 0.5), enable_padding=True,
                        pad_size=(60, 60)):
    ...
    return to_braille_from_image(img, reverse=reverse, size_percent=size_percent, max_x=max_x, max_y=max_y,
                                 sensitivity=sensitivity, enable_padding=enable_padding, pad_size=pad_size)


def to_braille_from_image(img: Image, reverse: bool = False, size_percent: typing.Optional[float] = None,
                          max_x: typing.Optional[int] = None, max_y: typing.Optional[int] = None,
                          sensitivity: typing.Tuple[float] = (0.5, 0.5, 0.5, 0.5), enable_padding=True,
                          pad_size=(60, 60)):
